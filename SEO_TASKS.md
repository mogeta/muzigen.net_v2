...
| タスク | 優先度 | ステータス | PR | レビュー |
|--------|--------|-----------|-----|----------|
| タスク1: RSS/Atomフィード | 高 | 未着手 | - | - |
| タスク2: JSON-LD構造化データ | 高 | 未着手 | - | - |
| タスク3: 記事日付OGPメタタグ | 中 | 未着手 | - | - |
| タスク4: Canonical URL | 中 | 未着手 | - | - |
| タスク5: OG画像サイズ指定 | 低 | 未着手 | - | - |
| タスク6: タグ/カテゴリーページ | 低 | 未着手 | - | - |
| タスク7: パンくずナビゲーション | 低 | 未着手 | - | - |
| タスク8: 関連記事表示 | 低 | 未着手 | - | - |
